...
|---|---|---|---|
| [`dots-friend-enemy/`](dots-friend-enemy/) | 2026-08-10 | Dots that chase one friend and flee one enemy — [notes](dots-friend-enemy/NOTES.md), [run it](dots-friend-enemy/index.html) | **v2.5** — ribbon trails, 5 looks, friend-graph basins, influences rendered as a bow shock, tooltips. Resume from "Picking this up cold" in the notes |
