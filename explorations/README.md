...
| [`evolution/`](evolution/) | 2026-08-11 | Evolution arena — foragers with heritable mutating genomes; selection tunes them live — [notes](evolution/NOTES.md), [run it](evolution/index.html) | v3 — adaptive radiation: two resources + diet gene split the population in two (42%/22%/36% at t=6.7k, γ dial crosses the phase boundary live); phylogeny strip forks; co-evolving predators |
