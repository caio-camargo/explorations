...
| [`evolution/`](evolution/) | 2026-08-11 | Evolution arena — foragers with heritable mutating genomes; selection tunes them live — [notes](evolution/NOTES.md), [run it](evolution/index.html) | v1 — r/K divergence measured (meadow patience 117 vs desert 192), refugium, meteor, trait histograms |
| [`journey-markov/`](journey-markov/) | 2026-08-12 | Journey Gravity — absorbing Markov chain over real (anonymized) site journeys; per-page P(ends booked) — [notes](journey-markov/NOTES.md), [run it](journey-markov/index.html) | v1.4 — 53-visitor ICP cohort; two absorption lenses that invert the ranking (booking event: marketing lane leads; visitor fate: product depth leads); [funnel Sankey](journey-markov/sankey.html) sibling page — modal booked session is 2 steps. Published with Caio's sign-off 2026-08-12 (aggregate data only) |
