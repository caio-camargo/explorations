...
| [`journey-markov/`](journey-markov/) | 2026-08-12 | Journey Gravity — absorbing Markov chain over real (anonymized) site journeys; per-page P(ends booked) — [notes](journey-markov/NOTES.md), [run it](journey-markov/index.html) | v1.1 — 53-visitor ICP cohort, gravity 50–88% around 75% base; product depth pulls up, billing pulls down. Fate layout: height = P(booked). Published with Caio's sign-off 2026-08-12 (aggregate data only) |
